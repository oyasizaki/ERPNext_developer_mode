...
#### Important
  Note: erpnext vervion 12 requires
* install python 3.7 (pyenv install 3.7.15) - set it as global(pyenv global 3.7.15)
* install Node v12 (nvm install 12) - set is as global (nvm alias default 12)
* install node-saas v4.12 (npm install node-sass@4.12) 
* install yarn v1.22.11 (npm install -g yarn@1.22.11) 
